...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        dayMaxEventRows: 3, // Mengatur agar maksimal 5 event yang ditampilkan per hari
        moreLinkText: function(num) { // Mengatur teks yang ditampilkan saat ada lebih dari 5 event
            return "+" + num + " more";
        },
